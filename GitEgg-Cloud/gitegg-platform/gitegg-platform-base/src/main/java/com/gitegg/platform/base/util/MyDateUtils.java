...
public class MyDateUtils extends DateUtils {
    ...
    public static long pastDays(String date) {
        if (MyStringUtils.isBlank(date)) return 0;
...
//		System.out.println(dateS);
    ...
    public static String getdateY(int dateqj, String type) {
        String dateY = MyDateUtils.getYear();
        String dates = "";
...
//	}
     ...
     */
    public final static String format(Long dateTime) {
    ...
    public static int getAgeByIdCard(String idCardNum) {
        try {
            ...
            Date birthDay = MyDateUtils.getDateFromString(strdate, "yyyyMMdd");
    ...
    public static Date getBirthdayByIdCard(String idCardNum) {
        try {
            String strdate = idCardNum.substring(6, 14);
            return MyDateUtils.getDateFromString(strdate, "yyyyMMdd");
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static String getCurrentQuarterStartTime() {
        String date = MyDateUtils.getQuarterEndTime(MyDateUtils.getDate());
